...
Examples:
  rewrite-gh-remotes.sh --old ve62ca --new xrryx --dry-run
  rewrite-gh-remotes.sh --old ve62ca --new xrryx
  rewrite-gh-remotes.sh --old ve62ca --new xrryx ~/dev/private ~/dev/work
USAGE
}
